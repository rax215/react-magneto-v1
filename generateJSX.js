    ...
    return new Promise ((resolve, reject) => {       
        ...
        masterLayout.componentList.forEach(component => {
          if(component.type === 'TextInput') {
            ...
            componentData.push({"compName" : "RadioGroup","jsx" :  ComponentLibrary.radioButtonComponent(component.attributes)})
            ...
            componentData.push({"compName" : "Container","jsx" : ComponentLibrary.textContainerComponent(component.attributes)});
            componentData.push({"compName" : "Paper","jsx" : ""});
            componentData.push({"compName" : "Grid","jsx" : ""});
          }
